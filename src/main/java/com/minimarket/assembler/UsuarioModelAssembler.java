...
/**
 * Ensambla un {@link Usuario} con enlaces HATEOAS: self, colección de
 * usuarios, sus carritos y sus ventas.
 */
@Component
public class UsuarioModelAssembler implements RepresentationModelAssembler<Usuario, EntityModel<Usuario>> {
    ...
    public EntityModel<Usuario> toModel(Usuario usuario) {
        return EntityModel.of(usuario,
                ...
                linkTo(methodOn(CarritoController.class).listarCarrito(usuario.getId())).withRel("carritos"),
                linkTo(methodOn(VentaController.class).listarVentas(usuario.getId())).withRel("ventas"));
    }
}

...
- [x] `./mvnw test` en `feat/eft-s9` termina en `BUILD SUCCESS` (SC-006) — reverificado
      2026-07-19 sobre JDK 25.0.3, **137/137** pruebas en 21 clases (20 de negocio +
...
| Ejecución de pruebas unitarias | `specs/001` + `specs/002` | VERIFICADA | `./mvnw test` → `BUILD SUCCESS`, **137/137** pruebas (reverificado 2026-07-19). |
